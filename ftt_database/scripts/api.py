...
"""api.py: Runs a web server to expose a JSON API to the FTT database."""
...
class ApiCommon:
    ...
    def get_json():
        ...
        try:
            ...
            msg = "[ERROR]: (DataError). Missing JSON data. DB query aborted."
            raise ApiError(msg, status_code=400)
        pass
    ...
    def get_any_params_from_json(param_names):
        ...
        if any(param in json_data for param in param_names):
            ...
            msg = "[ERROR]: (KeyError). No matching parameters in JSON data. DB query aborted."
            raise ApiError(msg, status_code=400)
        pass
    ...
    def get_all_params_from_url(param_names):
        ...
        for param_name in param_names:
            ...
            if value is not None:
                ...
                msg = "[ERROR]: (KeyError). Missing Key: '"+param_name+"' In URL parameters. DB query aborted."
                raise ApiError(msg, status_code=400)
        return data
    ...
    def get_any_params_from_url(param_names):
        ...
        if data:
            ...
            msg = "[ERROR]: (KeyError). No matching parameters in URL data. DB query aborted."
            raise ApiError(msg, status_code=400)
        pass
    ...
    def get_all_params_from_url_or_json(param_names):
        ...
        try:
            ...
            try:
                ...
                msg = "[ERROR]: (KeyError). Missing Key: '"+missing_key+"' In URL or JSON parameters. DB query aborted."
                raise ApiError(msg, status_code=400)
        return data
    ...
    def get_any_params_from_url_or_json(param_names):
        ...
        try:
            ...
            try:
                ...
                msg = "[ERROR]: (KeyError). No matching parameters in URL or JSON data. DB query aborted."
                raise ApiError(msg, status_code=400)
        return data
